...
class Graph {
  public:
    ...
    */
    ...
    // 三角形统计
    void triangle_statistics();

    void four_clique_statistics();
    ...
    // internal use only
    long long pattern_matching_edge_task(const Schedule_IEP &schedule, int edge_id, VertexSet vertex_sets[], VertexSet &partial_embedding,
  ...
  private:
    ...
    void remove_anti_edge_vertices(VertexSet &out_buf, const VertexSet &in_buf, const Schedule_IEP &sched, const VertexSet &partial_embedding,
                                   int vp);
    ...
    void pattern_matching_func(const Schedule_IEP &schedule, VertexSet *vertex_set, VertexSet &subtraction_set, long long &local_ans, int depth,
                               bool clique = false);
    ...
    void pattern_matching_aggressive_func_mpi(const Schedule_IEP &schedule, VertexSet *vertex_set, VertexSet &subtraction_set, VertexSet &tmp_set,
